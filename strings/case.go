...
const (
	...
	CamelCase          Case = "^[a-z][a-z0-9]*(?:[A-Z][A-Za-z0-9]*)+$"     // CamelCase 驼峰式（小驼峰式） e.g. "twoWords"
	CamelSnakeCase     Case = "^[a-z][a-z0-9]*(?:_[A-Z][A-Za-z0-9]*)+$"    // CamelSnakeCase 驼峰式蛇形（小驼峰式蛇形） e.g. "two_Words"
	PascalCase         Case = "^(?:[A-Z][A-Za-z0-9]*)+$"                   // PascalCase 帕斯卡式（大驼峰式） e.g. "TwoWords"
	PascalSnakeCase    Case = "^[A-Z][a-z0-9]*(?:_[A-Z][A-Za-z0-9]*)+$"    // PascalSnakeCase 帕斯卡蛇形（大驼峰式蛇形） e.g. "Two_Words"
